...
Tasks allow you to extract commands into classes. For example ``bake`` is made almost
entirely of tasks. You define tasks for a shell using the ``$tasks`` property::
